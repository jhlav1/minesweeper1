public class MinesweeperGame {
    ...
    public void getBoard() {
        printBoard(board);
    } // Calls the master board with all the answers

    // Helper Method to instantiate the board
    ...
    private int[][] populateBoard(int [][] inputBoard) { // Helper Method to randomly place mines
        ...
        // This section then assigns each space of number based on the surrounding mines.
    ...
    // Prints the board in a neat matrix
